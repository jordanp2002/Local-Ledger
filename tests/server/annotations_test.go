...
func TestToolAnnotationsDiscovery(t *testing.T) {
	tests := []struct {
		...
		{name: "create_savings_goal", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "update_savings_goal", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "list_savings_goals", readOnly: true, openWorld: false},
		{name: "allocate_to_savings_goal", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "release_savings_goal_funds", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "fund_savings_goal", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "reverse_savings_goal_funding", destructive: annotationBool(true), idempotent: true, openWorld: false},
		{name: "complete_savings_goal", destructive: annotationBool(false), idempotent: true, openWorld: false},
		{name: "cancel_savings_goal", destructive: annotationBool(false), idempotent: true, openWorld: false},
		{name: "get_savings_overview", readOnly: true, openWorld: false},
