...
var categoryToolNames = []string{"add_transaction", "create_category", "create_monthly_budget", "disable_category", "list_categories", "list_known_merchants", "list_transactions", "remove_transaction", "set_budgets", "set_known_merchant", "update_transaction"}
