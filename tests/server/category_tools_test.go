...
var categoryToolNames = []string{"add_split_transaction", "add_transaction", "add_transactions", "compare_months", "create_budget_rollover", "create_category", "create_monthly_budget", "create_recurring_transaction", "disable_category", "disable_recurring_transaction", "disable_sinking_fund", "enable_recurring_transaction", "enable_sinking_fund", "get_category_summary", "get_monthly_series", "get_monthly_summary", "get_spending_summary", "list_budget_rollovers", "list_categories", "list_known_merchants", "list_recurring_transactions", "list_sinking_funds", "list_top_merchants", "list_transactions", "materialize_due_transactions", "preview_due_transactions", "preview_upcoming_transactions", "remove_budget_rollover", "remove_known_merchant", "remove_transaction", "rename_category", "rename_known_merchant", "set_budgets", "set_known_merchant", "update_recurring_transaction", "update_transaction"}
