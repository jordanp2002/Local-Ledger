...
var categoryToolNames = []string{"create_category", "create_monthly_budget", "disable_category", "list_categories", "list_known_merchants", "set_budgets", "set_known_merchant"}
