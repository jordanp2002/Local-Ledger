...
var categoryToolNames = []string{"add_transaction", "add_transactions", "compare_months", "create_category", "create_monthly_budget", "create_recurring_transaction", "disable_category", "disable_recurring_transaction", "get_category_summary", "get_monthly_series", "get_monthly_summary", "get_spending_summary", "list_categories", "list_known_merchants", "list_recurring_transactions", "list_top_merchants", "list_transactions", "remove_known_merchant", "remove_transaction", "rename_category", "rename_known_merchant", "set_budgets", "set_known_merchant", "update_transaction"}
