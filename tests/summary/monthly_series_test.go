...
func TestSeriesAllowsEqualMonthsAndAtMost24ContiguousRows(t *testing.T) {
	...
	if one.Months[0] != (summary.SeriesMonth{
		Month: "2026-08", TotalBudget: nil, TotalSpending: "12.00", Remaining: nil,
...
func TestSeriesSnapshotAndSpendingOnlyRowsAreContiguous(t *testing.T) {
	...
	want := []summary.SeriesMonth{
		{
			Month: "2026-01", TotalBudget: stringPtr("500.00"), TotalSpending: "110.00",
		...
		{
			Month: "2026-03", TotalBudget: stringPtr("0.00"), TotalSpending: "0.00",
...
func TestSeriesCategoryFilterIncludesInactiveAndUsesStoredName(t *testing.T) {
	...
	want := []summary.SeriesMonth{
		{Month: "2026-08", TotalBudget: stringPtr("150.00"), TotalSpending: "40.00", Remaining: stringPtr("110.00"), SpentOfBudget: stringPtr("26.66"), TransactionCount: 1},
		{Month: "2026-09", TotalBudget: nil, TotalSpending: "5.00", Remaining: nil, SpentOfBudget: nil, TransactionCount: 1},
		{Month: "2026-10", TotalBudget: stringPtr("0.00"), TotalSpending: "7.00", Remaining: stringPtr("-7.00"), SpentOfBudget: nil, TransactionCount: 1},
	}
