...
const (
	...
	ErrorCodeGoalAllocationInsufficientBalance    ErrorCode = "goal_allocation_insufficient_balance"
	ErrorCodeGoalAllocationExceedsCurrent         ErrorCode = "goal_allocation_exceeds_current"
	ErrorCodeSavingsGoalTargetNotReached          ErrorCode = "savings_goal_target_not_reached"
	ErrorCodeSavingsGoalFundingNotFound           ErrorCode = "savings_goal_funding_not_found"
	ErrorCodeSavingsGoalFundingDependencyConflict ErrorCode = "savings_goal_funding_dependency_conflict"
...
func defaultErrorMessage(code ErrorCode) string {
	...
	case ErrorCodeGoalAllocationInsufficientBalance:
		return "The holding account does not have enough unallocated balance."
	case ErrorCodeGoalAllocationExceedsCurrent:
		return "The release amount exceeds the goal's current allocation."
	case ErrorCodeSavingsGoalTargetNotReached:
		return "The savings goal target has not been reached."
	case ErrorCodeSavingsGoalFundingNotFound:
		return "The requested savings goal funding entry was not found."
	case ErrorCodeSavingsGoalFundingDependencyConflict:
		return "The savings goal funding entry cannot be reversed."
